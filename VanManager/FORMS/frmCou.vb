...
Public Class frmCou
    ...
    Private Sub frmCou_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Mode = FormMode.ViewRecord Or Mode = FormMode.EditRecord Then
            ...
            End If
            Dim cmd As OleDbCommand = New OleDbCommand("Select * from cou where id ='" + ID + "'", cn)
        ...
        Else
            txtCode.Text = GetNewCode("COU")
            txtName.Select()
        End If
    End Sub
    Private Sub frmCou_Closed(sender As Object, e As EventArgs) Handles Me.Closed
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If Mode = FormMode.EditRecord Then
                ' Ενημέρωση Δεδομένων
                sSQL = "UPDATE cou set code = " & toSQLValueJ(txtCode, True) & ", " &
                       "name =  " & toSQLValueJ(txtName) &
                       "where id = '" & ID & "'"
                Using oCmd As New OleDbCommand(sSQL, cn)
                    oCmd.ExecuteNonQuery()
                End Using
                If CBJanus Is Nothing Then frmMain.FillJanusGrid("COU")
                If Not CBJanus Is Nothing Then
                    FillJanuscboCOU(CBJanus)
                    CBJanus.Value = ID
            ...
            ElseIf Mode = FormMode.NewRecord Then
                ...
                sSQL = "INSERT INTO cou (code,name) " &
                ...
                If Not CBJanus Is Nothing Then
                    FillJanuscboCOU(CBJanus)
                    CBJanus.Value = GetLastSavedGuid("COU", txtCode.Text).ToString
                    CBJanus.Text = txtName.Text
                    CBJanus.SelectedItem = CBJanus.Value
                    Me.Close()
                Else
                ...
                End If
            End If
            MessageBox.Show("Ο  Νομός αποθηκεύθηκε με επιτυχία", "VanManager", MessageBoxButtons.OK, MessageBoxIcon.Information)
