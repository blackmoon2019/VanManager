...
Public Class frmCUSTYPE
    ...
    Private Sub frmCUSTYPE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Mode = FormMode.ViewRecord Or Mode = FormMode.EditRecord Then
            ...
            End If
            Dim cmd As OleDbCommand = New OleDbCommand("Select * from CUSTYPE where id ='" + ID + "'", cn)
        ...
        Else
            txtCode.Text = GetNewCode("CUSTYPE")
            txtName.Select()
        End If
    End Sub
    Private Sub frmCUSTYPE_Closed(sender As Object, e As EventArgs) Handles Me.Closed
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If Mode = FormMode.EditRecord Then
                ' Ενημέρωση Δεδομένων
                sSQL = "UPDATE CUSTYPE set code = " & toSQLValueJ(txtCode, True) & ", " &
                       "name =  " & toSQLValueJ(txtName) &
                       "where id = '" & ID & "'"
                Using oCmd As New OleDbCommand(sSQL, cn)
                    oCmd.ExecuteNonQuery()
                End Using
                If CBJanus Is Nothing Then frmMain.FillJanusGrid("CUSTYPE")
                If Not CBJanus Is Nothing Then
                    FillJanuscboCUSTYPE(CBJanus)
                    CBJanus.Value = ID
            ...
            ElseIf Mode = FormMode.NewRecord Then
                ...
                sSQL = "INSERT INTO CUSTYPE (code,name) " &
               "values (" & toSQLValueJ(txtCode, True) & ", " &
                ...
                If Not CBJanus Is Nothing Then
                    FillJanuscboCUSTYPE(CBJanus)
                    CBJanus.Value = GetLastSavedGuid("CUSTYPE", txtCode.Text).ToString
                    CBJanus.Text = txtName.Text
                    CBJanus.SelectedItem = CBJanus.Value
                    Me.Close()
                Else
