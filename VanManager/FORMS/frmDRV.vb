...
Public Class frmDRV
    ...
    Private Sub frmDRV_Load(sender As Object, e As EventArgs) Handles Me.Load
        Call FillJanuscboCOU(cboCOU)
        Call FillJanuscboDOY(cboDOY)
        Call FillYesNoCombo(cboSalary)
        ...
        If Mode = FormMode.ViewRecord Or Mode = FormMode.EditRecord Then
            ...
            End If
            Dim cmd As OleDbCommand = New OleDbCommand("Select * from DRV where id ='" + ID + "'", cn)
            ...
            If (sdr.Read() = True) Then
                ...
                If sdr.IsDBNull(sdr.GetOrdinal("inhouse")) = False Then cboSalary.SelectedIndex = IIf(sdr.GetBoolean(sdr.GetOrdinal("inhouse")) = True, 1, 0)
    ...
    Private Sub frmdrv_Closed(sender As Object, e As EventArgs) Handles Me.Closed
        ...
        Try
            ...
            If Mode = FormMode.EditRecord Then
                ...
                sSQL = "UPDATE DRV set " &
                       ...
                       "inhouse = " & cboSalary.SelectedIndex & "," &
                       "salary =  " & Replace(txtSalary.Value, ",", ".") & " where id = '" & ID & "'"
                Using oCmd As New OleDbCommand(sSQL, cn)
                    oCmd.ExecuteNonQuery()
                End Using
                If CBJanus Is Nothing Then frmMain.FillJanusGrid("DRV")
                If Not CBJanus Is Nothing Then
                    FillJanuscboDRV(CBJanus)
                    CBJanus.Value = ID
            ...
            ElseIf Mode = FormMode.NewRecord Then
                ...
                sSQL = "INSERT INTO DRV ([code],[name],[lastname],[AreaID],[CouID],[Ar],[Address],[TK],[Phone1] " &
                   ",[Phone2],[Mobile1],[Mobile2],[Fax],[Email],[comments],[afm],[doyid],[inhouse],[salary]) " &
                ...
                Using oCmd As New OleDbCommand(sSQL, cn)
                    ...
                    If Not CBJanus Is Nothing Then
                        FillJanuscboDRV(CBJanus)
                        CBJanus.Value = GetLastSavedGuid("DRV", txtCode.Text).ToString
                        CBJanus.Text = txtLastname.Text + " " + txtName.Text
                        Me.Close()
                    Else
                ...
                End Using
            End If
            MessageBox.Show("Ο Οδηγός αποθηκεύθηκε με επιτυχία", "VanManager", MessageBoxButtons.OK, MessageBoxIcon.Information)
    ...
    Private Sub cboSalary_ValueChanged(sender As Object, e As EventArgs) Handles cboSalary.ValueChanged
        If cboSalary.SelectedIndex = 1 Then txtSalary.Enabled = True Else txtSalary.Enabled = False
    End Sub
