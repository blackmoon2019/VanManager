...
Public Class frmprf
    ...
    Private Sub frmPRF_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Mode = FormMode.ViewRecord Or Mode = FormMode.EditRecord Then
            ...
            End If
            Dim cmd As OleDbCommand = New OleDbCommand("Select * from PRF where id ='" + ID + "'", cn)
        ...
        Else
            txtCode.Text = GetNewCode("PRF")
            txtName.Select()
        End If
    End Sub
    Private Sub frmPRF_Closed(sender As Object, e As EventArgs) Handles Me.Closed
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        ...
        Try
            ...
            If Mode = FormMode.EditRecord Then
                ' Ενημέρωση Δεδομένων
                sSQL = "UPDATE prf set code = " & toSQLValueJ(txtCode, True) & ", " &
                       "name =  " & toSQLValueJ(txtName) &
                       "where id = '" & ID & "'"
                Using oCmd As New OleDbCommand(sSQL, cn)
                    oCmd.ExecuteNonQuery()
                End Using
                If CBJanus Is Nothing Then frmMain.FillJanusGrid("PRF")
                If Not CBJanus Is Nothing Then
                    FillJanuscboPRF(CBJanus)
                    CBJanus.Value = ID
            ...
            ElseIf Mode = FormMode.NewRecord Then
                ...
                sSQL = "INSERT INTO prf (code,name) " &
               "values (" & toSQLValueJ(txtCode, True) & ", " &
                ...
                If Not CBJanus Is Nothing Then
                    FillJanuscboPRF(CBJanus)
                    CBJanus.Value = GetLastSavedGuid("PRF", txtCode.Text).ToString
                    CBJanus.Text = txtName.Text
                    CBJanus.SelectedItem = CBJanus.Value
                    Me.Close()
                Else
                ...
                End If
            End If
            MessageBox.Show("Το επάγγελμα αποθηκεύθηκε με επιτυχία", "VanManager", MessageBoxButtons.OK, MessageBoxIcon.Information)
